        ...
        content = { paddingValues ->
            Box(
                ...
                Column(
                    ...
                    // Boton para borrar los productos de local storage
                    Box(modifier = Modifier.size(height = 50.dp, width = 220.dp)){
                        Button(onClick = {
                            val listaVacia = emptyList<Producto>()
                            val listaVacia2 = emptyList<Carrito>()
                            val listavacia3 = emptyList<Envio>()
                            val listaVacia4 = emptyList<Cliente>()
                            coroutinesScope.launch {
                                guardarCatalogo(contexto, listaVacia)
                                guardarCarrito(contexto, listaVacia2)
                                guardarEnvio(contexto, listavacia3)
                                guardarClientes(contexto, listaVacia4)
                            }
